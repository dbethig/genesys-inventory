	...
	<form class="char-wrap" action="<?php echo URLROOT; ?>/characters/new-character" method="post">
		...
		<div class="form-group d-flex mb-5">
			<div class="attribute-inner mr-4">
				...
				<input type="number" name="soak" class="form-control form-control-lg" value="<?php echo $data['soak']; ?>" min="0">
			</div>
			<div class="attribute-inner d-flex flex-column">
				...
				<div class="enc-wrap d-flex">
					<div class="enc-inner d-flex flex-column mr-2">
						<input type="number" name="enc_total" class="form-control form-control-lg" value="<?php echo $data['enc_total']; ?>" min="0">
						<label for="enc_total">Total</label>
					</div>
					<div class="enc-inner d-flex flex-column">
						<input type="number" name="enc_curr" class="form-control form-control-lg" value="<?php echo $data['enc_curr']; ?>" min="0">
