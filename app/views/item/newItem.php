...
<div class="mb-3">
	...
	<a class="btn btn-warning float-right" id="testBtn">Test</a>
</div>
<div class="card card-body bg-light mt-2">
	<?php echo flash('page_err'); ?>
	<h2>Create a new item</h2>
	<form class="item-wrap" action="<?php echo URLROOT; ?>/items/newitem/<?php echo
	$data['item__character_id'] .':' .$data['item']['item__container_id']; ?>" method="post">
		<div class="form-row" id="item_row-main">
			...
			<div class="form-group col-md-2" style="text-align: center; <?php echo $data['item']['iten__inc'] != 0 ? 'display: none': ''; ?>" id="pack-wrap">
		...
		<div class="form-row" id="item_row-nums">
			...
			<div class="form-group col-md-2">
				...
				<div class="cost-wrap">
					...
					<input type="number" name="item__cost_total" id="item__cost_total" class="form-control <?php echo $isCustomCost ? 'cust-val' : ''; ?> <?php echo (!empty($data['item_err']['item__cost_total_err'])) ? 'is-invalid' : '' ; ?>" value="<?php echo $data['item']['item__cost_total']; ?>" <?php echo $isCustomCost ? 'enabled' : 'disabled' ?>>
		...
		<div class="form-row" id="item_row-attr1">
			<div class="form-group col-md-2">
		...
		<div class="form-row" id="item_row-attr2">
